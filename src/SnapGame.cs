...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			if (myGame.IsStarted) { if ( SwinGame.KeyTyped (KeyCode.vk_LSHIFT) && SwinGame.KeyTyped (KeyCode.vk_RSHIFT))
			else if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT)) { myGame.PlayerHit (0); }
